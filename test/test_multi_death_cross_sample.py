...
def test_multi_death_cross_strategy():
    """
    测试多死叉共振策略
    ...
    if selected_stocks:
        ...
        for i, stock in enumerate(selected_stocks, 1):
            ...
            print(f"  均线死叉日期: {stock['ma_cross_date']}")
            print(f"  KDJ死叉日期: {stock['kdj_cross_date']}")
            print(f"  MACD死叉日期: {stock['macd_cross_date']}")
...
if __name__ == '__main__':
    test_multi_death_cross_strategy()
